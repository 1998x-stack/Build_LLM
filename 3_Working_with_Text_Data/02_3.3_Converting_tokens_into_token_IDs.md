...
---
### 相关代码 / Related code
- 对应实现: [`02_3.3_Converting_tokens_into_token_IDs.py`](02_3.3_Converting_tokens_into_token_IDs.py)
- 参见 Related: 特殊上下文标记见 [3.4](03_3.4_Adding_special_context_tokens.md)；嵌入转换见 [3.1](00_3.1_Understanding_word_embeddings.md)