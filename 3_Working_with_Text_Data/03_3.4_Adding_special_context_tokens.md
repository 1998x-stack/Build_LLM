...
---
### 相关代码 / Related code
- 对应实现: [`03_3.4_Adding_special_context_tokens.py`](03_3.4_Adding_special_context_tokens.py)
- 参见 Related: 标记器见 [3.3](02_3.3_Converting_tokens_into_token_IDs.md)；BPE见 [3.5](04_3.5_Byte_pair_encoding.md)
