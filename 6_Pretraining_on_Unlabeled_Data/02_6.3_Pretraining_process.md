...
---
### 相关代码 / Related code
- 对应实现: [`02_6.3_Pretraining_process.py`](02_6.3_Pretraining_process.py)
- 参见 Related: 数据准备见 [6.2 数据准备](01_6.2_Data_preparation.md)；评估见 [6.4](03_6.4_Evaluating_pretrained_model.md)；GPT实现见 [5.2 实现GPT模型](../5_Implementing_a_GPT_model_from_Scratch_To_Generate_Text/01_5.2_Implementing_GPT_model.md)；参考实现见 [common/attention.py](../common/attention.py)
