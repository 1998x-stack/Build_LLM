...
def evaluate_model(model, data_loader):
    ...
    # 示例评估（调用 evaluate_model 得到各指标后打印）
...
---
### 相关代码 / Related code
- 对应实现: [`03_6.4_Evaluating_pretrained_model.py`](03_6.4_Evaluating_pretrained_model.py)
- 参见 Related: 预训练过程见 [6.3 预训练过程](02_6.3_Pretraining_process.md)；GPT实现见 [5.2 实现GPT模型](../5_Implementing_a_GPT_model_from_Scratch_To_Generate_Text/01_5.2_Implementing_GPT_model.md)；参考实现见 [common/attention.py](../common/attention.py)
